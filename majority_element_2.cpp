...
/*
return nums that appear more than n/3 times
in any array only two elements can appear more than n/3 times
n = 9 ; n / 3 = 3; 4 + 4 = 8

so keep two candidates and two counts to track them.
*/
class Solution {
public:
